...
const en = {
  ...
  hub: {
    ...
    pollingToken: "Polling token", pollingTokenHint: "Must match each agent's API token. Blank keeps the current one.",
...
const zh: typeof en = {
  ...
  hub: {
    ...
    pollingToken: "轮询令牌", pollingTokenHint: "需与各 agent 的 API 令牌一致。留空则保留当前值。",
