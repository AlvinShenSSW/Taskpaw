...
const en = {
  ...
  pipeline: {
    ...
    queued: "Queued", notStarted: "Not started", after: "Waiting for {{step}}",
    ...
    tile: {
      speed: "Speed", elapsed: "Elapsed", eta: "Left", scene: "Scene", phase: "Phase",
...
const zh: typeof en = {
  ...
  pipeline: {
    ...
    tile: {
      speed: "速度", elapsed: "已用", eta: "约剩", scene: "场景", phase: "阶段",
      batches: "批次", cues: "已译",
    },
    cues: "{{done}} / {{total}} 句",
