...
const en = {
  logs: {
    ...
    fields: {
      ...
      queued: "Queued", done: "Done", failed: "Failed", skipped: "Skipped", duration: "Duration (seconds)",
      ...
      reason: "Reason", detail: "Detail", step: "Step", elapsed: "Elapsed (seconds)", reconstructed: "Inferred",
    ...
    kinds: {
      ...
      task_done: "Task finished: {{done}} done, {{failed}} failed, {{skipped}} skipped, {{kept_ja}} Japanese lines kept, {{paused}} paused, in {{duration}} s",
      ...
      restore_finished: "Restoration finished: {{output}}, in {{duration}} s",
      ...
      asr_started: "Speech recognition started with {{engine}}", asr_finished: "Speech recognition finished: {{lines}} lines in {{duration}} s", asr_retry: "Retrying speech recognition",
      ...
      translate_refused: "{{model}} refused {{count}} lines",
      ...
      translate_finished: "Translation finished: {{lines}} lines ({{by_model}}), {{kept_ja}} Japanese lines kept, in {{duration}} s",
...
const zh: typeof en = {
  logs: {
    ...
    fields: {
      ...
      queued: "排队", done: "完成", failed: "失败", skipped: "跳过", duration: "耗时（秒）",
      kept_ja: "保留日文行数", paused: "暂停", resumed: "续译行数", count: "数量",
      title: "提醒标题", message: "原始提醒", level: "提醒级别", output: "输出", srt: "字幕文件",
      reason: "原因", detail: "详情", step: "步骤", elapsed: "已用时间（秒）", reconstructed: "推断记录",
    ...
    kinds: {
      ...
      task_done: "任务完成：完成 {{done}}，失败 {{failed}}，跳过 {{skipped}}，保留日文 {{kept_ja}} 行，暂停 {{paused}}，耗时 {{duration}} 秒",
      ...
      restore_finished: "修复完成：{{output}}，耗时 {{duration}} 秒",
      restore_failed: "修复失败（退出码 {{exit_code}}）", restore_retry: "使用 {{mode}} 模式重试修复",
      restore_skipped: "跳过修复：{{reason}}",
      asr_started: "开始语音识别，使用 {{engine}}", asr_finished: "语音识别完成：{{lines}} 行，耗时 {{duration}} 秒", asr_retry: "重试语音识别",
      ...
      translate_refused: "{{model}} 拒绝翻译 {{count}} 行",
      ...
      translate_finished: "翻译完成：{{lines}} 行（{{by_model}}），保留日文 {{kept_ja}} 行，耗时 {{duration}} 秒",
